...
//     TH1F *v_e2  = new TH1F("#bar{#nu}_{e}", "", 300, 0., 300.);
     ...
     TH1F *v_mu1  = new TH1F("#nu_{#mu}", "", 50, 0., 1375.);
     TH1F *v_mu2  = new TH1F("#bar{#nu}_{#mu}", "", 50, 0., 1375.);
     TH1F *v_e1  = new TH1F("#nu_{e}", "", 50, 0., 1375.);
     TH1F *v_e2  = new TH1F("#bar{#nu}_{e}", "", 50, 0., 1375.);
...
// TTree *g = new TTree("MyTree", "MyTree");
