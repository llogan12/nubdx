...
my $shifty=11./2.; # vertical plane semi-distance
my $shiftLong=0.5; # distance between long bars
my $shiftShort=0.5;
...
sub make_EEE_ASTRO
{
    ...
    my $csi_pad_lx =20/2.;
    my $csi_pad_ly =1.0/2 ;
    my $csi_pad_lz =30./2 ; # TO BE CHECKED
    my $X = -30./2.-$shiftShort;
    my $Y = $shifty;
    ...
    $detector{"visible"}     = 1;
    $detector{"type"}        = "Box";
    # da qui cominciano i corti
    my $csi_pad_sx =20/2.;
    my $csi_pad_sy =1.0/2 ;
    my $csi_pad_sz =30./2 ; # TO BE CHECKED
    ...
    $detector{"material"}    = "ScintillatorB"; #Scintillator B chiedere come mettere un altro tipo di scintiallatore nel nostro caso BC400!!
    $detector{"sensitivity"} = "veto";
    $detector{"hit_type"}    = "veto";
